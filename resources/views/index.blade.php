...
<body>
                            ...
                            <div class="navbar-item">
                                <div class="buttons">
                                    <a class="button is-primary" data-scroll href="#booking">
                                        <strong>Pesan Tiket Sekarang</strong>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-image">
                                    <figure class="image is-4by3">
                                        <img src="{{ asset('storage/' . $g->thumbnail) }}" alt="Placeholder image">
                                    </figure>
                                </div>
                                <div class="card-content">
                                    <div class="media">
                                        <div class="media-content">
                                            <p class="title is-5">{{ $g->judul }}</p>
                                        </div>
                                    </div>
                                ...
                                <footer class="card-footer">
                                    <a href="/detail/{{ $g->id }}" class="card-footer-item">Lihat
                                        artikel</a>
                                </footer>
                            </div>
                        </li>
    ...
    <div id="histats_counter">
        ...
        <script type="text/javascript">
            var _Hasync = _Hasync || [];
            _Hasync.push(['Histats.start', '1,4691931,4,603,110,40,00001001']);
        ...
        <noscript><a href="/" target="_blank"><img src="//sstatic1.histats.com/0.gif?4691931&101"
