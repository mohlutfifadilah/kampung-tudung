                                ...
                                @foreach ($video as $a)
                                    <tr>
                                        ...
                                        <td data-label="link"><a
                                                href="{{ 'https://www.youtube.com/watch?v=' . $a->link }}"
                                                target="_blank"
                                                rel="noopener noreferrer">{{ 'https://www.youtube.com/watch?v=' . $a->link }}</a>
                                        </td>
                                        <td data-label="deskripsi">{{ $a->deskripsi }}</td>
                                        <td class="is-actions-cell">
                                            <div class="buttons is-center">
                                                <a href="/video/{{ $a->id }}/edit"
                ...
                @if ($video->count())
                    ...
                    <div class="columns px-5 pb-5">
                        ...
                        <div class="column has-text-right">
                            <small>
                                Halaman ke {{ $video->currentPage() }} dari
                                {{ $video->count() }}
                            </small>
                        </div>
                    </div>
