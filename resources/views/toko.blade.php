            ...
            <div class="column">
                <nav class="breadcrumb mt-3" aria-label="breadcrumbs">
                    <ul>
                        ...
                        <li class="is-active"><a href="#" aria-current="page">Toko</a></li>
                    </ul>
                </nav>
            </div>
        </div>
    </section>
    <section class="container is-fluid toko my-5" id="toko">
                ...
                <div class="column is-3 has-text-centered">
                    <div class="card">
                        ...
                        <footer class="card-footer">
                            <a href="/toko/{{ $m->id }}" class="card-footer-item button is-primary">Lihat
                                Produk</a>
                        </footer>
                    </div>
                </div>
